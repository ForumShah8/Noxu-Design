      ...
      <div className="w-screen h-fit  justify-center flex py-4 border-t border-t-slate-300">
        <div className="w-3/4 px-24">
          <div className='flex space-x-4 px-2'>
             <button className='border  p-2 border-slate-300 rounded-md text-xs'>Suggest question 1</button>
             <button className='border  p-2 border-slate-300 rounded-md text-xs'>Suggest question 2</button>
             <button className='border  p-2 border-slate-300 rounded-md text-xs'>Suggest question 3</button>
           </div>
            <div className='flex py-4 px-2 w-full '>
              <button className='flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 border border-e-0 border-slate-300 rounded-l-md ' type='button'>
              ...
              <div className='relative w-full'>
                <input type='search' className='w-full block p-2.5 z-20 text-sm  text-gray-900 bg-white rounded-e-md rounded-s-gray-100 rounded-s-2 border border-slate-300 ' placeholder='Start a new chat'>    
                </input>
                <button className='absolute top-0 end-0 p-2.5 h-full text-sm font-medium rounded-e-md border border-slate-300 border-l-0'>
