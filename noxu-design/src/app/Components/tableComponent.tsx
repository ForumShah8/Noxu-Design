export default function DataTableComponent(){
  ...
  // this is a dummy data for table
const dummyData = [
  {
    " ": "477",
    "Name": "Abbott - Pacocha",
    ...
    "City":"Colombus",
    "State":"CO",
    "Segment":"Enter Some segment data",
    "OwnerID":"7"
  },
  {
    " ": "477",
  ...
  },
  {
    ...
    return (
      // this is the UI part where table is returned from along with some buttons above and below it
      <div className="bg-slate-100 h-fit  w-screen  justify-center flex">
          <div className=' px-24 py-7 w-3/4'>
            <div className="inline-flex">
              <button className= " flex items-center  bg-white border  border-slate-300 text-orange-500 text-sm font-bold  px-2 rounded-l-md">
              ...
              <button className=" flex items-center bg-white border  border-slate-300 border-l-0 text-orange-500 text-sm font-bold py-1 px-2 rounded-r-md">
                <div className='mr-1'>
                Human Help
                </div>
      ...
      <div className="border rounded-md overflow-auto bg-white mt-1 ">
        ...
        <tbody className="divide-y divide-gray-200">
          {dummyData.map((data,index) =>(
            <tr key={index}>
              <td className="py-2 whitespace-nowrap text-sm font-medium text-gray-800 px-6">
                <p className="flex items-center">
                  {data[" "]}
                </p>
              </td>
              <td className="py-2 whitespace-nowrap text-sm text-gray-800 max-w-52 px-6">
                <p className="flex items-center">
                  {data["Name"]}
                </p>
              </td>
              <td className="py-2 whitespace-nowrap text-sm text-gray-800 max-w-2 px-6">
                <p className="flex items-center">
                  {data["Industry"]}
                </p>
              </td>
              <td className="py-2 text-sm text-gray-800 px-4">
                <p className="max-w-12 truncate">
                  {data["City"]}
                </p>
              </td>
              <td className="py-2 whitespace-nowrap text-sm text-gray-800 px-4">
                <p className="flex items-center">
                  {data["State"]}
                </p>
              </td>
              <td className="py-2 text-sm text-gray-800  px-4">
                <p className=" truncate max-w-12">
                  {data["Segment"]}
                </p>
              </td>
              <td className="py-2 whitespace-nowrap text-sm text-gray-800 px-4">
